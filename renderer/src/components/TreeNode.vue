<template>
  <div class="tree-node">
    <div class="tree-item" @click="handleClick">
      ...
      <svg v-if="node.type === 2" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#6c5ce7" stroke-width="1.5"><path d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"/></svg>
      ...
      <span style="font-size: 14px;">{{ node.title }}</span>
    </div>
